...
if ! command -v grype >/dev/null 2>&1; then
    ...
    log_error "Installation: curl -sSfL https://raw.githubusercontent.com/anchore/grype/main/install.sh | sh -s -- -b /usr/local/bin v0.113.0"
...
set_default_env "SYFT_VERSION" "v1.45.0"
set_default_env "GRYPE_VERSION" "v0.113.0"
