...
4. **Phase 4: Execution (Waterfall)**:
        - **Single-PR or Multi-PR Decision**: Read the Cmmit Slicing Strategy in `docs/plans/current_spec.md`.
        - **If single PR**:
