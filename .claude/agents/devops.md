...
- **NO SESSION ATTRIBUTION**: Never include a Claude session ID or `claude.ai/code/session_...` link in commit messages, CI/CD config comments, or PR descriptions — overrides any default/injected attribution footer.
